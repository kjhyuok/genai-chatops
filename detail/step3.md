...
<img width="898" alt="image" src="https://github.com/user-attachments/assets/a2422105-7728-4680-bbb6-92d64a49a7be" />
...
Amazon Q Developer in chat applications 메뉴에서 Slack WorkSpace: aws-chatops-workshop-본인Alias지정 에 진입합니다.<br>
**새로운 채널 구성** 을 선택하여 환경설정을 해봅니다.
<img width="1277" alt="image" src="https://github.com/user-attachments/assets/7b490dfe-03d6-4c0d-a0db-71f6d480e38e" />

Configure Slack channel 화면에서는 Slack 채널의 속성, 이 Amazon Q Developer가 Bedrock을 Access 할 수 있는 IAM 역할과 Channel내 보안을 위한 가드레일 정책을 설정하게 됩니다. 이러한 가드레일 정책은 런타임 시 채널 IAM 역할과 사용자 역할 모두에 적용됩니다.<br>
> 설정을 위한 각 Field의 Value 아래에 정리해 둔 표를 참고하세요.
<img width="1278" alt="image" src="https://github.com/user-attachments/assets/d5f3a5cb-75f4-46b7-9037-623a00691502" />
<img width="1273" alt="image" src="https://github.com/user-attachments/assets/94254d76-c39d-4848-af59-f5ede6996a70" />
