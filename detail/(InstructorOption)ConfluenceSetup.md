### Confluence Setup
Confluence는 이 Workshop에서 2가지 용도로 활용 됩니다.
1. IT운영 자산이 등록되어 있다고 가정하고, Amazon Bedrock Knowledge Bases에 임베딩 후 RAG에 활용
2. Slack Thread에 있는 내용을 Reporting되는 Space로 활용
...
최초 생성된 Confluence에는 Amazon Bedrock Knowledge Bases에 임베딩 할만한 Reporting 자료가 없습니다. 따라서 2가지의 방법이 사전에 필요합니다.
   3-1. 따라서 Instructor가 사전에 업로드 해 주시거나
   3-2. Amazon Bedrock Knowledge Bases를 S3로만 임베딩 하고 Reporting만 Confluence에 하시는 것을 권장 드립니다.
